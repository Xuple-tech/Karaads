...
import { ArrowLeft, Save, Globe, Palette, Settings } from 'lucide-react';

const Create = ({ users, siteTypes, industries, timezones }) => {
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Register a new site for AI agent deployment
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem >Not specified</SelectItem>
                    ...
                    <div className="flex justify-end space-x-4">
                        <Button variant="outline" asChild>
                            <Link href={route('admin.sites.index')}>Cancel</Link>
                        </Button>
