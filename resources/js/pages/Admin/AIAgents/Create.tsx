// @/Pages/Admin/AIAgents/Create.tsx
...
import { ArrowLeft, Save, Bot, Palette, Globe, Code, Settings } from 'lucide-react';

const Create = ({ users, sites, templates, agentTypes, widgetPositions, languages }) => {
    const { data, setData, errors, processing, post } = useForm({
        ...
        working_hours: {},
        offline_message: 'Sorry, I am currently offline. Please try again during working hours.',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.ai-agents.store'));
    };
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Create a new AI agent with custom settings and behavior
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <TabsContent value="basic" className="space-y-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Set up the basic details of your AI agent
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                value={data.site_id || ''}
                                                onValueChange={(value) => setData('site_id', value === 'none' ? '' : value)}
                                            >
                                                <SelectTrigger>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                ...
                                                onValueChange={(value) => setData('template_id', value === 'none' ? '' : value)}
                                            >
                                                <SelectTrigger>
