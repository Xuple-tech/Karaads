        ...
        children: [
            {
                ...
                children: [
                    ...
                    { path: '/slides', lazy: () => import('@/spa/routes/app/slides-dashboard') },
                    { path: '/docs', lazy: () => import('@/spa/routes/app/docs-dashboard') },
                    { path: '/docs/editor/:documentId', lazy: () => import('@/spa/routes/app/docs-editor') },
                    { path: '/slides/:presentationId', lazy: () => import('@/spa/routes/app/slide-library') },
                    { path: '/slides/:presentationId/present', lazy: () => import('@/spa/routes/app/slide-present') },
