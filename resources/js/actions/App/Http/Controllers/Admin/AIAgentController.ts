...
/**
* @see \App\Http\Controllers\Admin\AIAgentController::toggleStatus
...
const AIAgentController = { index, create, store, show, edit, update, destroy, toggleStatus, clone, exportMethod, importMethod, export: exportMethod, import: importMethod }
