 ...
 */
export const toggleStatus = (args: { agentPlan: string | { id: string } } | [agentPlan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/agent-plans/{agentPlan}/toggle'
 */
toggleStatus.url = (args: { agentPlan: string | { id: string } } | [agentPlan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { agentPlan: args }
    }
 ...
 * @route '/admin/agent-plans/{agentPlan}/toggle'
 */
toggleStatus.patch = (args: { agentPlan: string | { id: string } } | [agentPlan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggleStatus.url(args, options),
    method: 'patch',
})
