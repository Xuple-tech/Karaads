...
/**
* @see \App\Http\Controllers\Admin\AgentPlanController::toggleStatus
 * @see app/Http/Controllers/Admin/AgentPlanController.php:169
 * @route '/admin/agent-plans/{agentPlan}/toggle'
 */
export const toggleStatus = (args: { agentPlan: string | number | { id: string | number } } | [agentPlan: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/agent-plans/{agentPlan}/toggle'
 */
toggleStatus.url = (args: { agentPlan: string | number | { id: string | number } } | [agentPlan: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { agentPlan: args }
    }
 ...
 * @route '/admin/agent-plans/{agentPlan}/toggle'
 */
toggleStatus.patch = (args: { agentPlan: string | number | { id: string | number } } | [agentPlan: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggleStatus.url(args, options),
    method: 'patch',
})
...
const AgentPlanController = { index, create, store, show, edit, update, destroy, toggleStatus, syncStripe }

export default AgentPlanController