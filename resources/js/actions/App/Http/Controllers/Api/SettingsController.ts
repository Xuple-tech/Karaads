...
updateProfile1832f1672671756d505f6dc56e3743cf.definition = {
    methods: ["put"],
...
updateProfileb5de1dc0893215715131da3e39e754ac.definition = {
    methods: ["put"],
...
export const updateProfile = {
    '/api/settings/profile': updateProfile1832f1672671756d505f6dc56e3743cf,
    '/api/settings/mgmt/r4t7y0u3/profile/update/i6o9p2l5': updateProfileb5de1dc0893215715131da3e39e754ac,
}
...
changePassword2f7da1bb7a45f41a5e5a293d2991ff06.definition = {
    methods: ["put"],
...
changePasswordcc2c50205f8d76f80b817e634aabad64.definition = {
    methods: ["put"],
...
export const changePassword = {
    '/api/settings/password': changePassword2f7da1bb7a45f41a5e5a293d2991ff06,
    '/api/settings/mgmt/r4t7y0u3/password/change/h8j1k4z7': changePasswordcc2c50205f8d76f80b817e634aabad64,
}
...
getApiKeys2b34d64457bf5ef77518c217fb0451f3.definition = {
    methods: ["get","head"],
...
getApiKeys8ebf49d9bd53ae58c60ccf3fad380991.definition = {
    methods: ["get","head"],
...
export const getApiKeys = {
    '/api/settings/api-keys': getApiKeys2b34d64457bf5ef77518c217fb0451f3,
    '/api/settings/mgmt/r4t7y0u3/apikeys/list/g0f3d6s9': getApiKeys8ebf49d9bd53ae58c60ccf3fad380991,
}
...
addOllamaKeyef80d55a4fd670f5b2ec454027e698ac.definition = {
    methods: ["post"],
...
addOllamaKeya76d982c345dbfb490184d884dcec409.definition = {
    methods: ["post"],
...
export const addOllamaKey = {
    '/api/settings/api-keys/ollama': addOllamaKeyef80d55a4fd670f5b2ec454027e698ac,
    '/api/settings/mgmt/r4t7y0u3/apikeys/ollama/t4y7u0i3': addOllamaKeya76d982c345dbfb490184d884dcec409,
}
...
addOpenRouterKey4ee3104d8efea373cbdfdcbce675d818.definition = {
    methods: ["post"],
...
addOpenRouterKeyeb1b7ccf79df7c6d88cc525c1096a418.definition = {
    methods: ["post"],
...
export const addOpenRouterKey = {
    '/api/settings/api-keys/openrouter': addOpenRouterKey4ee3104d8efea373cbdfdcbce675d818,
    '/api/settings/mgmt/r4t7y0u3/apikeys/openrouter/p6a9s2d5': addOpenRouterKeyeb1b7ccf79df7c6d88cc525c1096a418,
}
...
updateApiKeyStatusd8c3a91c80543e01749931be4d75cecc.definition = {
    methods: ["put"],
...
updateApiKeyStatusb6506665773d7fa234179d55397914d8.definition = {
    methods: ["put"],
...
export const updateApiKeyStatus = {
    '/api/settings/api-keys/{type}/{id}/status': updateApiKeyStatusd8c3a91c80543e01749931be4d75cecc,
    '/api/settings/mgmt/r4t7y0u3/apikeys/status/{type}/{uuid}/l8z1x4c7': updateApiKeyStatusb6506665773d7fa234179d55397914d8,
}
...
deleteApiKey037af8e759ad263a2af1c68ea90fd4a9.definition = {
    methods: ["delete"],
...
deleteApiKeyc3e205788e02a63bc2fe4063303451fb.definition = {
    methods: ["delete"],
...
export const deleteApiKey = {
    '/api/settings/api-keys/{type}/{id}': deleteApiKey037af8e759ad263a2af1c68ea90fd4a9,
    '/api/settings/mgmt/r4t7y0u3/apikeys/delete/{type}/{uuid}/v0b3n6m9': deleteApiKeyc3e205788e02a63bc2fe4063303451fb,
}
...
getAiModes1a9dd2893acf41cf72907970e73d7cdf.definition = {
    methods: ["get","head"],
...
getAiModes69d03caad2380519a28fc03a6c860e61.definition = {
    methods: ["get","head"],
...
export const getAiModes = {
    '/api/settings/ai-modes': getAiModes1a9dd2893acf41cf72907970e73d7cdf,
    '/api/settings/mgmt/r4t7y0u3/ai/modes/k2j5h8g1': getAiModes69d03caad2380519a28fc03a6c860e61,
}
...
getAiPreferencesd825eb2c16d1853742009f6d46909bd0.definition = {
    methods: ["get","head"],
...
getAiPreferences0066ed74dba6e87acf115dd020618849.definition = {
    methods: ["get","head"],
...
export const getAiPreferences = {
    '/api/settings/ai-preferences': getAiPreferencesd825eb2c16d1853742009f6d46909bd0,
    '/api/settings/mgmt/r4t7y0u3/ai/prefs/f4d7s0a3': getAiPreferences0066ed74dba6e87acf115dd020618849,
}
...
updateAiPreferencesd825eb2c16d1853742009f6d46909bd0.definition = {
    methods: ["put"],
    url: '/api/settings/ai-preferences',
} satisfies RouteDefinition<["put"]>
...
updateAiPreferencesdbdf8c6dfed862d7c7dba4849ce3aca2.definition = {
    methods: ["put"],
...
export const updateAiPreferences = {
    '/api/settings/ai-preferences': updateAiPreferencesd825eb2c16d1853742009f6d46909bd0,
