...
/**
* @see \App\Http\Controllers\Admin\SiteController::toggle
 * @see app/Http/Controllers/Admin/SiteController.php:221
 * @route '/admin/sites/{site}/toggle'
 */
export const toggle = (args: { site: string | number | { id: string | number } } | [site: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/sites/{site}/toggle'
 */
toggle.url = (args: { site: string | number | { id: string | number } } | [site: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { site: args }
    }
 ...
 * @route '/admin/sites/{site}/toggle'
 */
toggle.patch = (args: { site: string | number | { id: string | number } } | [site: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggle.url(args, options),
    method: 'patch',
})
...
toggleWidget: Object.assign(toggleWidget, toggleWidget),
verify: Object.assign(verify, verify),
resendVerification: Object.assign(resendVerification, resendVerification),
embedCode: Object.assign(embedCode, embedCode),
