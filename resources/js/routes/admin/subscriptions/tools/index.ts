...
*/
export const byCategory = (args: { plan: string | { id: string } } | [plan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/admin/subscriptions/plans/{plan}/tools/by-category'
*/
byCategory.url = (args: { plan: string | { id: string } } | [plan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { plan: args }
    }
...
* @route '/admin/subscriptions/plans/{plan}/tools/by-category'
*/
byCategory.get = (args: { plan: string | { id: string } } | [plan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: byCategory.url(args, options),
    method: 'get',
})
...
* @route '/admin/subscriptions/plans/{plan}/tools/by-category'
*/
byCategory.head = (args: { plan: string | { id: string } } | [plan: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: byCategory.url(args, options),
    method: 'head',
})
