...
*/
export const toggle = (args: { agentKnowledgeBase: string | { id: string } } | [agentKnowledgeBase: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/admin/agent-knowledge-bases/{agentKnowledgeBase}/toggle'
*/
toggle.url = (args: { agentKnowledgeBase: string | { id: string } } | [agentKnowledgeBase: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { agentKnowledgeBase: args }
    }
...
* @route '/admin/agent-knowledge-bases/{agentKnowledgeBase}/toggle'
*/
toggle.patch = (args: { agentKnowledgeBase: string | { id: string } } | [agentKnowledgeBase: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggle.url(args, options),
    method: 'patch',
})
