...
/**
* @see \App\Http\Controllers\Admin\AgentKnowledgeBaseController::toggle
 ...
 */
export const toggle = (args: { agentKnowledgeBase: string | number | { id: string | number } } | [agentKnowledgeBase: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/admin/agent-knowledge-bases/{agentKnowledgeBase}/toggle'
 */
toggle.url = (args: { agentKnowledgeBase: string | number | { id: string | number } } | [agentKnowledgeBase: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { agentKnowledgeBase: args }
    }
 ...
 * @route '/admin/agent-knowledge-bases/{agentKnowledgeBase}/toggle'
 */
toggle.patch = (args: { agentKnowledgeBase: string | number | { id: string | number } } | [agentKnowledgeBase: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggle.url(args, options),
    method: 'patch',
})
...
export default agentKnowledgeBases