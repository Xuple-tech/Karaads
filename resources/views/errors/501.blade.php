...
<head>
    ...
    <title>{{ config('app.name') }} | 501 Not Implemented</title>
    <style>
        :root {
            color-scheme: light;
            --bg-start: #0f172a;
...
<body>
    <main class="card" role="main" aria-labelledby="error-title">
        ...
        <p class="badge">501 Not Implemented</p>
        <h1 id="error-title">This feature is not supported.</h1>
        <p>
            The server does not support the functionality required to fulfill your request.
            Please check the URL or return to the homepage.
        </p>
        <p class="status">HTTP 501 - Not Implemented</p>
    </main>
</body>
</html>