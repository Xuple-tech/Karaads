...
<head>
    ...
    <title>{{ config('app.name') }} | 504 Gateway Timeout</title>
    <style>
        :root {
            color-scheme: light;
            --bg-start: #0f172a;
...
<body>
    <main class="card" role="main" aria-labelledby="error-title">
        ...
        <p class="badge">504 Gateway Timeout</p>
        <h1 id="error-title">The server took too long to respond.</h1>
        <p>
            The upstream server failed to send a request in time. Please try again later.
            If the problem persists, contact our support team.
        </p>
        <p class="status">HTTP 504 - Gateway Timeout</p>
    </main>
</body>
</html>