...
export default function EarnPage() {
  ...
  return (
    <>
      <Head title="Earn" />
      <div className="min-h-screen bg-[#060b14] pb-24 text-white">
        <div className="px-3 pt-4">
          <div className="mx-auto max-w-[430px] overflow-hidden rounded-[38px] border border-[#243454] bg-[radial-gradient(circle_at_top,_rgba(25,86,140,0.22),_transparent_34%),linear-gradient(180deg,#0a1220_0%,#0b1322_38%,#19112d_100%)] shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
            <div className="px-5 pb-6 pt-6">
              <div className="flex items-center justify-between">
                <h1 className="text-[18px] font-black tracking-tight text-white">
                  <span className="text-[#38bdf8]">Kara</span>Earn
                </h1>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-xs font-bold text-[#15f17d] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
                  <span className="h-2.5 w-2.5 rounded-full bg-[#15f17d]" />
                  Earning Active
                </div>
              </div>

              <div className="mt-5 overflow-hidden rounded-[34px] border border-[#2f4d78] bg-[linear-gradient(135deg,#113e64_0%,#1a2b5a_42%,#4f1f85_100%)] p-6 shadow-[0_18px_50px_rgba(0,0,0,0.28)]">
                <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-white/55">
                  Total Earned
                </p>
                <div className="mt-4 flex items-end gap-2">
                  <p className="text-[54px] font-black leading-none tracking-tight text-white">
                    {formatCurrency(wallet?.balance ?? earnings?.available_balance ?? 0).replace(
                      ".00",
                      "",
                    )}
                  </p>
                  <span className="pb-2 text-[28px] font-black text-[#08d2ff]">
                    {displayCurrency}
                  </span>
                </div>
                ...
                <div className="mt-6 flex items-end justify-between gap-4">
                  <div>
                    <p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-white/35">
                      Pending Payout
                    </p>
                    <p className="mt-2 text-[18px] font-black text-[#08d2ff]">
                      {formatCurrency(
                  ...
                  <Button
                    type="button"
                    className="h-14 rounded-full bg-[linear-gradient(90deg,#08d2ff,#3b82f6)] px-8 text-[18px] font-black text-[#03111f] shadow-[0_12px_30px_rgba(8,210,255,0.35)] hover:opacity-95"
                    onClick={() => {
              ...
              <div className="mt-5 grid grid-cols-3 gap-3">
                <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] px-3 py-5 text-center">
                  <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-full bg-white/6 text-white">
                    <Play className="h-5 w-5 fill-white" />
                  </div>
                  <p className="text-[29px] font-black leading-none text-white">
                    {earnings?.ads_completed ?? earnings?.ads_watched ?? 0}
                  </p>
                  <p className="mt-3 text-[11px] font-extrabold uppercase tracking-[0.14em] text-white/38">
                    Ads Watched
                  </p>
                </div>
                ...
                <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] px-3 py-5 text-center">
                  ...
                  <p className="truncate px-1 text-[clamp(0.72rem,2.8vw,1.8125rem)] font-black leading-none text-white">
              ...
              <div className="mt-4 space-y-3">
                {recentHistory.length > 0 ? (
                  recentHistory.map((transaction, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex items-center gap-3 rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.03))] px-4 py-4"
                      >
                        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[18px] border border-white/10 bg-[linear-gradient(180deg,rgba(110,77,175,0.2),rgba(27,34,53,0.4))]">
                        ...
                        <div className="text-right">
                          <p className="text-[16px] font-black text-[#08d2ff]">
                  ...
                  <div className="rounded-[24px] border border-white/10 bg-white/[0.04] px-4 py-5 text-sm font-medium text-white/55">
