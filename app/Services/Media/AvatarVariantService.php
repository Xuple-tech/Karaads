...
class AvatarVariantService
{
    ...
    public function generate(string $sourcePath, string $disk = 'public'): array
    {
        ...
        $sizes = config('media.avatar.sizes', []);
        $quality = (int) config('media.avatar.quality', 85);
        ...
        try {
            ...
            try {
                ...
                Log::warning('Failed to generate avatar variant; using fallback copy.', [
